    ...
    <div className="flex justify-center w-full px-2 pt-2">
      <div className="flex justify-center flex-col w-full max-w-5xl gap-y-2 md:gap-y-4">
        ...
        child:py-2 sm:child:py-0 sm:child:border-none child:p-1">
          <div className="w-full sm:w-[calc(40%-4px)] md:w-[calc(30%-8px)]">
          ...
          <div className="w-full sm:w-[calc(60%-4px)] md:w-[calc(70%-8px)]">
            <div className="flex items-center justify-start gap-x-2">
            ...
            <div className="my-1">
              <label className="relative inline-flex items-center me-5 cursor-pointer">
                ...
                <div className="w-11 h-6 bg-secondary rounded-full peer peer-checked:after:translate-x-full 
